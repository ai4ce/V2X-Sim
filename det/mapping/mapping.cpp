                             ...
                             const double voxel_size)
{
    ...
    double next_voxel_boundary_z = (vz+stepZ)*0.4f; // correct
    ...
    double tDeltaZ = (ray[2]!=0) ? 0.4f/ray[2]*stepZ : DBL_MAX;
                                 ...
                                 const double lo_free)
{
    ...
    const int vxsize = (pxmax - pxmin) / voxel_size;
    const int vysize = (pymax - pymin) / voxel_size;
    const int vzsize = ceil((pzmax - pzmin) / 0.4f);
    const Eigen::Vector3i grid_size(vxsize, vysize, vzsize);
                                 ...
                                 const double lo_free)
{
    ...
    const int vxsize = (pxmax - pxmin) / voxel_size;
    const int vysize = (pymax - pymin) / voxel_size;
    const int vzsize = (pzmax - pzmin) / 0.4;
    const Eigen::Vector3i grid_size(vxsize, vysize, vzsize);
