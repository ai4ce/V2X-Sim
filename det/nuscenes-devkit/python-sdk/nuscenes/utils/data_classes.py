...
#            current_sd_rec = nusc.get('sample_data', current_sd_rec['next'])
    ...
    def from_file_multisweep_upperbound_sample_data(cls,
        ...
        num_sensor = ((len(sample_record['data']) - NUM_CROSS_ROAD_SENSOR) // NUM_TYPES_OF_SENSORS) + 1
    ...
    def from_file_multisweep_warp2com_sample_data(cls,
        ...
        if return_trans_matrix:
            return current_pc, np.squeeze(all_times, 0), trans_matrix_list, trans_matrix_list_no_cross_road, target_agent_id, num_sensor
        else:
