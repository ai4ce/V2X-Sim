...
if __name__ == "__main__":
    ...
    parser.add_argument('-r', '--root', default='/data_1/yml/carScene-mini', type=str, help='Root path to nuScenes dataset')
    parser.add_argument('-s', '--split', default='val', type=str, help='The data split [train/val/test]')
    ...
    parser.add_argument('-e', '--scene_end', default=9, type=int, help='scene_end')
