...
class Config(object):
	def __init__(self,split,binary=True,only_det=True,code_type='faf',loss_type='faf_loss',savepath='',root='', is_cross_road=False):
		...
		# TODO: comfirm with det
		self.category_threshold = [0.4,0.4,0.25,0.25,0.4]; self.class_map = {'vehicle.car': 1, 'vehicle.emergency.police':1, 'vehicle.bicycle':3, 'vehicle.motorcycle':3, 'vehicle.bus.rigid':2}
